                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 font-semibold">
                      {lastBackup.metadata?.totalDays || 0} days •{" "}
                      {lastBackup.metadata?.totalSites || 0} sites •{" "}
                      {(lastBackup.metadata?.dataSize / 1024).toFixed(2) || 0}{" "}
                      KB
                    </p>
                  </div>
                </div>
                <button className="px-4 py-2 bg-white hover:bg-gray-50 text-gray-900 rounded-lg font-bold border-2 border-gray-900 transition-all shadow-sm hover:shadow-md">
                  Restore
                </button>
              </div>
            </div>
