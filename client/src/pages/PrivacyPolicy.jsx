...
const PrivacyPolicy = () => {
  ...
  const { privacyPolicyAccepted } = useSelector((state) => state.auth);
    ...
    <div className="min-h-screen bg-amber-50 py-30">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-6 mb-12">
          ...
          <div className="bg-white rounded-2xl p-8 border-2 border-gray-900 shadow-lg hover:shadow-xl transition-shadow">
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0 w-12 h-12 bg-amber-100 rounded-xl flex items-center justify-center border-2 border-gray-900">
        ...
        {privacyPolicyAccepted ? (
          <div className="bg-gradient-to-br from-green-400 to-emerald-400 rounded-2xl p-8 border-2 border-gray-900 shadow-xl">
          ...
          <div className="bg-gradient-to-br from-amber-400 to-orange-400 rounded-2xl p-8 border-2 border-gray-900 shadow-xl">
            <label className="flex items-start gap-4 mb-6 cursor-pointer group">
              ...
              <span className="text-lg font-semibold text-gray-900 group-hover:text-gray-800 transition-colors">
                I have read and agree to the Privacy Policy and understand how my
                data will be used
              </span>
            </label>
