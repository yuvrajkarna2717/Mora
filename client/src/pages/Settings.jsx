...
import { Moon, Sun, Bell, Trash2, Link as LinkIcon } from "lucide-react";
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          ...
          <p className={theme === "dark" ? "text-gray-400" : "text-gray-600"}>
            Customize your Mora experience
          </p>
        </div>
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={toggleTheme}
              className={`p-3 rounded-lg \${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'} transition-colors`}
            >
              {theme === "dark" ? (
