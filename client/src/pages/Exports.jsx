      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className={theme === "dark" ? "text-gray-400" : "text-gray-600"}>
            Download your productivity data in multiple formats
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <p>
                <span className="font-medium">Includes:</span> Time tracking,
                productivity scores, category breakdown, top sites, AI insights
              </p>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white text-lg font-semibold rounded-lg hover:shadow-xl transition-all flex items-center justify-center gap-3"
          >
        ...
        >
          ...
          <div className="space-y-3">
            {[
              {
                name: "November_2025_Report.pdf",
                date: "2025-11-15",
                size: "2.4 MB",
              },
              {
                name: "October_2025_Data.xlsx",
                date: "2025-11-01",
                size: "1.8 MB",
              },
              {
                name: "Q4_2025_Analytics.csv",
                date: "2025-10-15",
                size: "856 KB",
              },
            ].map((file, idx) => (
